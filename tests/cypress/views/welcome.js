...
export const applicationPage = {
    shouldExist: () => {
        cy.get('.bx--detail-page-header-title', {timeout: 15000 }).should('contain', 'Applications')
    }
}

export const grcPage = {
    shouldExist: () => {
        cy.get('.bx--detail-page-header-title', {timeout: 15000 }).should('contain', 'Governance and risk')
    }
}
