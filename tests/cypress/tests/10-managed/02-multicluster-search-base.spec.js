      ...
      function () {
        it(`[P2][Sev2][${squad}] should find each managed cluster has default namespace`, function () {
          savedSearches.validateClusterNamespace(
            { namespace: 'default', cluster: this.clusterName },
            ''
          )
        })
        ...
        it(`[P2][Sev2][${squad}] should be able to save current default search`, function () {
        ...
        it(`[P2][Sev2][${squad}] should be able to save current ocm-agent search`, function () {
          savedSearches.saveClusterNamespaceSearch(
            this.clusterName,
        ...
        it(`[P2][Sev2][${squad}] should be able to find the open-cluster-management-agent saved searches after logging back in`, function () {
          savedSearches.getSavedSearch(queryOcmaNamespaceName)
        })
      }
    )
