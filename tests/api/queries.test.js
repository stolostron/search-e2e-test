...
if (!SEARCH_API_V1) {
  console.log('Skipping queries.test for V2. This is a temporary workaround while we complete the migration.')
  test.todo('SKIPPING FOR V2 - Search API - Verify results of different queries')
} else {
